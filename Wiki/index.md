...
Entry point for the Fishbone SSAS knowledge base.
Every article must be listed here. Categories and articles are alphabetical.
Maintenance rules: `../CLAUDE.md`, section 2; in full in `Processes/knowledge-base-operations.md`.
...
- [Empowered Trustees Ltd (corporate trustee)](People/empowered-trustees.md) - independent corporate trustee, registration 12291059; executed the loanback security
- [I Fedonina (member trustee)](People/i-fedonina.md) - joined January 2024, on the bank mandate May 2024, trustee by April 2025; deed of appointment at the administrator, not on file
- [M Gaudiesius (member trustee)](People/m-gaudiesius.md) - member trustee, director of the principal employer, owner of this knowledge base; signed the loanback security on both sides

## Processes
- [Establishment of the Fishbone SSAS, 2021](Processes/scheme-establishment-2021.md) - application 28/09/2021, pack 30/09/2021, signature pages photographed 14/10/2021, commencement 28/10/2021, HMRC 03/12/2021; dated originals at the administrator
- [Knowledge base operations (Drive, GitHub, Smartsheet)](Processes/knowledge-base-operations.md) - systems, ids, conventions in force, the full wiki rules and the nine-step Raw workflow
- [Scheme rules (Empowered Pension Ltd SSAS Scheme Rules)](Processes/scheme-rules.md) - the administrator's standard rules naming this scheme; trustee, employer, membership, lending and corporate-trustee consent provisions; unsigned copy

## Suppliers
- [Dollman & Pritchard (solicitors, loanback security)](Suppliers/dollman-pritchard.md) - drew the April 2025 legal mortgage; invoice and completion statement on file
- [Empowered Pensions Ltd (scheme administrator)](Suppliers/empowered-pensions.md) - administrator appointed at establishment; group companies, staff, invoices and the 2021 setup emails from Gmail; 2018 fee schedule on file; agreement unreadable by the tooling
- [Metro Bank (scheme bank account)](Suppliers/metro-bank.md) - opening request signed 31/10/2021; 2024 mandate on file with the signing rule; the loan advance paid on the administrator's transfer form 24/04/2025; no statements on file

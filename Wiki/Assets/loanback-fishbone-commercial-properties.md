...
| Loan agreement | Empowered Pensions Limited template, reference LA01801, "made on 16 Apr 2025"; the mortgage deed refers to it as the agreement "for the provision of the loan facilities secured by this deed" | [^12] pp.1, 3; [^1] p.6 |
| Parties to the agreement | Lender: the three member trustees and Empowered Trustees Ltd (CRN 12291059) "as Trustees of the FISHBONE SSAS (PSTR 20005255RF)"; Borrower: Fishbone Commercial Properties Ltd (CRN 13687238). The members' home addresses appear on p.3 and are not repeated here | [^12] p.3 |
| Interest | **5.50 percent per annum**, a stated rate with no reference to base rate; payable monthly in arrears from one month after Drawdown; any rate change apportioned daily (cl. 7.5) | [^12] p.6 cl. 6.1-6.3, p.7 cl. 7.5 |
| Default interest | 8.25 percent per annum on any overdue sum, accruing monthly, payable on demand | [^12] p.6 cl. 6.4 |
| Term | repaid no later than **5 years from the date of Drawdown**, Drawdown being "the date the monies leave the lenders bank account" | [^12] p.3, p.6 cl. 7.1 |
| Repayments | first repayment no later than Drawdown plus one month, then no less than monthly; each repayment "equivalent to the balance outstanding on the repayment date divided by the number of repayment dates remaining", that is **equal capital instalments with interest on top**; part and full early repayment allowed on one month's notice, no penalty; nothing may be redrawn | [^12] pp.6-7 cl. 7.2-7.9 |
| Fees under the agreement | set-up fee 350.00 and transaction fee 45.00, "paid by the borrower"; legal fees for the security and any exit fee borne by the borrower | [^12] p.7 cl. 8 |
| Conditions precedent | the Borrower's signed duplicate; a **board minute of the Borrower** authorising the loan and the security and nominating signatories; the signed Full Legal Mortgage | [^12] p.4 cl. 2.1 |
...
**Timeline from the documents.** The agreement was generated by Empowered Lending on 10/04/2025,
signed by the four trustees on 10 and 11/04/2025 and completed on 16/04/2025, the date it bears
...
44. The scheme rules allow a trustee to act despite a personal interest (rule 6.6) and require
the corporate trustee's written agreement to exercise the investment and lending powers (rule
6.3.1); Empowered Trustees Ltd signed the agreement through its director on 11/04/2025 [^12]
p.15 and executed the deed [^1] p.43, which is that written agreement. See
[Scheme rules](../Processes/scheme-rules.md). The agreement's own condition precedent of a
**board minute of the Borrower** [^12] cl. 2.1(b) is a document of Fishbone Commercial Properties
Ltd; the trustees' side has a board minute and indemnity letter among the Signable files of
07/04/2025, not yet filed.

...
Documents known to exist but **not on file**: the loan agreement dated 16 April 2025 between the
trustees and Fishbone Commercial Properties Ltd (referred to in the Legal Mortgage); the executed
trust deed and rules; any deed appointing the third individual trustee or admitting a
participating employer; Metro Bank statements; scheme accounts and returns. The four documents
that Session 2 listed here as OneDrive-only are now on file (rows above).
